# 📸 PHOTO GATHERING INSTRUCTIONS - Next Steps

**Date:** December 1, 2025  
**Status:** ✅ Code cleaned, bugs fixed, validated, deployed  
**Next:** Photo session → Content population → Domain switchover
...
- ✅ **StandardizedItem.jsx** - Enhanced to handle:
  ...
  - Availability status (links to location hours)
  - Age restriction badges visible in BOTH basic and detailed views
...
- ✅ **Removed duplicates:**
  ...
  - Moved `PHOTO_PLACEMENT_GUIDE.md` into project directory

- ✅ **Clean documentation structure:**
  - `STORE_PHOTOGRAPHY_GUIDE.md` - Location photos (8 shots, 20-30 min)
  - `MENU_PHOTOGRAPHY_GUIDE.md` - RoCafé items (10-15 shots, 30-45 min)
...
- [ ] Free up 5GB+ storage
- [ ] Clean camera lens
- [ ] Turn on Camera Grid (Settings → Camera → Grid)
...
- [ ] Turn on ALL lights
- [ ] Remove clutter, price tags, personal items
...
**Interior (5-6 shots):**
4. **interior-aisle.jpg** - Main aisle overview, leading lines
5. **interior-checkout.jpg** - Point of sale area
6. **interior-rocafe.jpg** - Café corner/area
7. **interior-products-1.jpg** - Snacks/chips section
8. **interior-products-2.jpg** - Refrigerated drinks
9. **interior-products-3.jpg** - International products (optional)

**Take 5-10 shots of each, pick the best later!**
...
- [ ] Gift card display rack
- [ ] Package pickup counter
...
1. **Logo** (512x512px PNG with transparency)
   - If you have an existing logo, just optimize it
...
3. **OG Image** (1200x630px)
   - Design in Canva: Store photo + logo + tagline
   - Or send me the store photo and I'll create it
...
4. **Straighten:** Use grid to align
...
📁 roma-mart-photos/
  📁 location/
    ...
    - interior-rocafe.jpg
    - interior-products-1.jpg
    - interior-products-2.jpg
...
Calories: 120
Allergens: Dairy
Description: Our signature cappuccino features...
```
...
5. ✅ Update all image paths in location data
...
4. ✅ Test on official domain
5. ✅ **SITE LIVE ON ROMAMART.CA** 🎉
...
- [x] Photo guides created
- [x] Menu template created
...
- [ ] Build, test, deploy with real content
- [ ] Review on GitHub Pages
- [ ] Domain switchover preparation
...
- [ ] Rename using correct convention
- [ ] Fill out ROCAFE_MENU_TEMPLATE.md
- [ ] Send me everything!
...
1. **Don't Rush:** Quality photos > speed. Take 5-10 shots per item.
2. **Use Natural Light:** 10am-2pm window is critical.
3. **Keep It Simple:** Clean backgrounds, no clutter.
4. **Check Focus:** Tap screen to focus before shooting.
5. **Hold Steady:** Use both hands, brace against stable surface.
6. **Edit Thoughtfully:** Brighten, but keep it natural.
7. **Optimize Files:** Smaller = faster loading = better UX.
8. **Follow Naming:** Exact filenames from guide = zero debugging.
...
- OG image creation?
- Photo editing?
- Menu data formatting?
- Anything else?

**Just ask!** I'm here to help. Once you send the photos and menu data, I'll handle all the technical integration and we'll have your site ready for domain switchover! 🚀
