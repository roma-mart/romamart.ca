    ...
    rules: {
      ...
      'no-restricted-syntax': [
        'error',
        {
          ...
          message:
            'Avoid hardcoded Tailwind gray text classes (text-gray-100 through text-gray-800). Use CSS variables: var(--color-text) or var(--color-text-muted). Note: text-gray-900 on bg-yellow is allowed for high contrast.',
        },
        {
          selector: 'JSXAttribute[name.name="className"] > Literal[value=/bg-gray-[0-9]/]',
          message:
            'Avoid hardcoded Tailwind gray backgrounds. Use CSS variables: var(--color-bg), var(--color-surface), or import { useThemeColors } from utils/theme.',
        },
        {
          selector: 'JSXAttribute[name.name="className"] > Literal[value=/border-gray-[0-9]/]',
          message:
            'Avoid hardcoded Tailwind gray borders. Use CSS variable: var(--color-border) or import { useThemeColors } from utils/theme.',
        },
      ],
