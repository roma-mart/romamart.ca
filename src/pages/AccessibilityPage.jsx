    ...
    <div className="min-h-screen pt-32 pb-16" style={{ backgroundColor: 'var(--color-bg)' }}>
      ...
      <section className="max-w-4xl mx-auto px-4 mb-16">
        <div className="flex flex-wrap items-start justify-between gap-4 mb-6">
          <h1 className="text-4xl md:text-5xl uppercase" style={{ color: 'var(--color-heading)' }}>
        ...
        <p className="text-lg font-inter leading-relaxed mb-4" style={textColor}>
          Roma Mart Convenience is committed to ensuring digital accessibility for people with disabilities. We strive
          to maintain and continually improve the accessibility of our website to conform to WCAG 2.2 Level AA.
        </p>
      ...
      <section className="max-w-4xl mx-auto px-4 mb-20">
        <h2 className="text-3xl uppercase mb-12" style={{ color: 'var(--color-heading)' }}>
          ...
          {[
            {
              ...
              subtitle: 'W3C web accessibility standard',
              description:
                'Our website is built to conform to the Web Content Accessibility Guidelines (WCAG) 2.2 at Level AA, the current international standard for web accessibility.',
              link: 'https://www.w3.org/WAI/WCAG22/quickref/',
            },
            {
              title: 'AODA Compliant',
              subtitle: 'Ontario accessibility regulation',
              description:
                "We comply with Ontario's Accessibility for Ontarians with Disabilities Act (AODA) and its Integrated Accessibility Standards Regulation (IASR) for web content.",
              link: 'https://www.ontario.ca/laws/regulation/070191',
            },
          ].map((item, idx) => (
            <div
              key={idx}
        ...
        >
          ...
          <p style={textColor}>
            We regularly audit our site to maintain conformance and are monitoring the development of WCAG 3.0 to adopt
            improvements as the standard evolves.
          </p>
        </div>
      </section>
        ...
        <div className="space-y-6">
          {[
            ...
            <div className="flex gap-4" key={i}>
              ...
              />
              <div>
                <h3 className="font-bold text-lg mb-1" style={textColor}>
                  {title}
                </h3>
                <p style={textColor}>
                  {title === 'Keyboard Navigation' &&
                    'All functionality is accessible via keyboard. Navigate with Tab, activate with Enter/Space, and close dialogs with Escape. Modal dialogs and menus trap focus to prevent keyboard users from getting lost.'}
                  {title === 'Visible Focus Indicators' &&
                    'High-contrast focus outline shows keyboard focus on all interactive elements, ensuring you always know where you are on the page.'}
                  {title === 'Screen Reader Support' &&
                    'Semantic HTML, ARIA labels, live regions for form errors and status messages, and descriptive link text ensure compatibility with NVDA, JAWS, and VoiceOver screen readers.'}
                  ...
                  {title === 'Enhanced Color Contrast' &&
                    'Text and UI components are designed to meet WCAG AA contrast requirements across both light and dark themes.'}
                  {title === 'Reduced Motion Support' &&
                    'If you enable "Reduce motion" in your operating system preferences, animations and transitions on our site are minimized or disabled.'}
                  {title === 'Resizable Text & Zoom' &&
                    'Text can be resized up to 200% without loss of content or functionality. Content reflows properly on all zoom levels.'}
                  {title === 'Touch-Friendly Targets' &&
                    'Buttons, links, and form inputs are sized for comfortable touch interaction, meeting mobile accessibility standards.'}
                </p>
              </div>
            </div>
          ))}
      ...
      <section className="max-w-4xl mx-auto px-4 mb-20">
        ...
        <p className="mt-8 leading-relaxed" style={textColor}>
          We will make reasonable efforts to provide accommodations and respond to accessibility inquiries within 5
          business days.
        </p>
      </section>
      ...
      <section className="max-w-4xl mx-auto px-4">
        ...
        <div className="rounded-lg p-8" style={{ backgroundColor: 'var(--color-primary)' }}>
          <p className="text-lg leading-relaxed mb-6" style={{ color: 'var(--color-text-on-primary)' }}>
          ...
          <ul className="space-y-3" style={{ color: 'var(--color-text-on-primary)' }}>
            {[
              'Maintaining WCAG 2.2 Level AA conformance',
              'Regular accessibility audits and remediation',
              'Rapid response to accessibility issues (5 business days)',
              'Training our team on accessibility best practices',
              'Monitoring evolving standards including WCAG 3.0',
            ].map((item, idx) => (
              <li className="flex items-start gap-3" key={idx}>
                <span className="font-bold mt-1" style={{ color: 'var(--color-accent)' }}>
                  ✓
                </span>
                <span>{item}</span>
              </li>
        ...
        <div className="mt-12 p-6 rounded-lg text-center" style={{ backgroundColor: 'var(--color-surface)' }}>
          <p className="mb-4" style={textColor}>
            <strong>Last Accessibility Audit:</strong> February 7, 2026
          </p>
          <p style={textColor}>
            <strong>Next Review Scheduled:</strong> May 2026
          </p>
        </div>
      </section>
    </div>
