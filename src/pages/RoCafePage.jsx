...
import { groupExcelItemsByCategory, groupStaticMenuByCategory } from '../utils/excelMenuTransform';
...
const RoCafePage = () => {
  ...
  const menuCategories = useMemo(() => {
    ...
    // Fallback to static menu when API is unavailable
    return groupStaticMenuByCategory(ROCAFE_FULL_MENU);
  }, [menuItems]);
