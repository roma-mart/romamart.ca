  ...
  return (
    <div className="min-h-screen pt-32 pb-16" style={{ backgroundColor: 'var(--color-surface)' }}>
      ...
      <section className="max-w-7xl mx-auto px-4 mt-16">
        ...
        >
          <h2 className="text-2xl mb-6" style={{ color: 'var(--color-heading)' }}>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-6">
            ...
            <div>
              <h4 className="text-heading font-bold text-lg mb-3" style={{ color: 'var(--color-heading)' }}>
                Tobacco & Vapour Products
              </h4>
              <div
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="text-sm font-inter" style={{ color: 'var(--color-error-dark)' }}>
                    <p className="font-bold mb-2">
                      It is illegal to sell or supply tobacco or e-cigarettes to anyone under 19 years of age.
                    </p>
              ...
              <p className="text-xs font-inter" style={mutedTextColor}>
                Required signage displayed in-store per{' '}
                <a
            ...
            <div>
              ...
              <div
                className="p-4 rounded-lg border-2 mb-4"
                style={{ backgroundColor: 'var(--color-warning-bg)', borderColor: COLORS.yellow }}
              >
                <div className="flex items-start gap-3">
                  <div className="text-3xl">🎫</div>
          ...
          <div className="pt-4 border-t" style={{ borderColor: 'var(--color-border)' }}>
            <p className="text-xs font-inter italic" style={mutedTextColor}>
              Roma Mart is committed to responsible retailing and strict compliance with all Ontario regulations. We
              reserve the right to refuse service to anyone who cannot provide valid identification. All required
              regulatory signage is prominently displayed in-store.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="p-12 rounded-3xl text-center" style={{ backgroundColor: 'var(--color-primary)' }}>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a
              ...
              className="px-8 py-4 rounded-full font-bold font-inter transition-all shadow-lg transform hover:scale-105 focus-visible:scale-105 hover:brightness-95 focus-visible:brightness-95"
              style={{
